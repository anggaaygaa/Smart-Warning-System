...
<div x-data="{
    ...
    <div class="w-full relative overflow-auto pr-2 rounded-[16px] bg-[#F9F9FB] dark:bg-[#1a1b24] border border-[#E5E5EF] dark:border-[rgba(255,255,255,0.05)] transition-colors duration-300">
